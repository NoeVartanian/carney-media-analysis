...
Updated: 
    ...
    - Filtered out articles that do not mention "Carney" in headline, snippet, or description.
    ...
    with open(args.output, 'w', newline='', encoding='utf-8') as f:
        ...
        for page_data in raw_responses:
            ...
            for article in articles:
                ...
                # Filter out articles that do not mention "Carney" in headline, snippet, or description.
                # We do not consider keywords.
                if "Carney" not in headline and "Carney" not in snippet and "Carney" not in description:
                    continue
                data_list.append([ArticleID,url,source,date,headline,snippet,description,keywords])
...
def main():
    ...
    row_names = ['ArticleID','url','Source','Date','Headline','Snippet','Description','Keywords']
